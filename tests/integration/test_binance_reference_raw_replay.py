    ...
    return json.dumps(
        {
            ...
            "data": {
                "e": "bookTicker", "u": 100, "E": 1790196000100, "T": 1790196000099,
                "s": symbol, "ps": symbol, "b": "100", "B": "1", "a": "101", "A": "2", "st": 1,
            },
        },
        separators=(",", ":"),
    ).encode()
    ...
    return json.dumps(
        {
            ...
            "data": {
                "e": "aggTrade", "E": 1790196000200, "s": symbol, "a": 77,
                "p": "100.5", "q": "0.5", "nq": "0.5", "f": 10, "l": 12,
                "T": 1790196000198, "m": False, "st": 1,
            },
        },
        separators=(",", ":"),
    ).encode()
